        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donation_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatergoryID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Disaster_Catergory_CatergoryID",
                        column: x => x.CatergoryID,
                        principalTable: "Catergory",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Disaster_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Disaster_CatergoryID",
                table: "Disaster",
                column: "CatergoryID");

            migrationBuilder.CreateIndex(
                name: "IX_Disaster_IdentityUserId",
                table: "Disaster",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Donation_IdentityUserId",
                table: "Donation",
                column: "IdentityUserId");
        }
