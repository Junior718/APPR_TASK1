...
namespace APPR_TASK1.Controllers
{
    public class DonationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Amount,Date,Items,Description")] Donation donation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Amount,Date,Items,Description")] Donation donation)
        {
            if (id != donation.Id)
            {
                return NotFound();
